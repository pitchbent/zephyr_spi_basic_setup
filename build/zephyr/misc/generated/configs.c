...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NUM_IRQS, 142);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DCDC_VALUE, 0x12);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_KINETIS_ETHERNET_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_KINETIS_LPUART_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_KINETIS_PTP_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_KINETIS_TRNG_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_MCUX_12B1MSPS_SAR_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_TEST_SPI_LOOPBACK_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_TEST_SPI_LOOPBACK_FAST_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_MIMXRT1020_EVK, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_MIMXRT1021, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_PART_NUMBER_MIMXRT1021DAG5A, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_PART_NUMBER_IMX_RT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_SERIES_IMX_RT10XX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_INIT_ENET_PLL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IMXRT1XXX_CODE_CACHE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IMXRT1XXX_DATA_CACHE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SPI_MCUX_LPSPI_DMA, 1);
